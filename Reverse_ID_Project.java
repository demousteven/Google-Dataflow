...
/**
 * A dataflow pipeline that finds ReverseId on the Walett Project : (a) Remove the first and second row if the ReverseId is equal
 *  
 *  
 *  
 ...
 *
 */
public class Reverse_ID_Project {
	...
	public static void main(String[] args) {
		...
		String WalettQuery = "SELECT __key__.id, ReverseID, [From],[DateTime],[To],[Type],[TT],[ToType],FromType,Comms,ToMethod,FromMethod,Metadata,Voucher.id FROM [dev6celbux:dev6celbux.F1_11]  where ReverseID is null ";
		PCollection<String[]> WalettContent = p.apply("GetJava", BigQueryIO.Read.fromQuery(WalettQuery)) //
		...
		PCollectionView<Map<String, Integer>> packagesThatNeedHelp = WalettContent
